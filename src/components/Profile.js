        ...
        <div className="card shadow" style={{height: '100%'}} >
            <div className="card-body" style={{padding:'0'}}>
                <div className="px-3 py-3">
                    <img className="mb-4"  src={images} alt="Profile" style={{width:'60%'}}/>
                ...
                <ul className="list-group" style={{width:'100%', margin:'0', padding:'0'}}>
                    <li className="list-group-item py-3" style={{cursor:"pointer"}} onClick={handelClick} id="0">
                        <div style={{display: 'flex'}}>
                    ...
                    <li className="list-group-item py-3" style={{cursor:"pointer"}} id="1" onClick={handelClick}>
                        <div style={{display: 'flex'}} >
                    ...
                    <li className="list-group-item py-3" style={{cursor:"pointer"}} id="2" onClick={handelClick}>
                        <div style={{display: 'flex'}}>
                    ...
                    <li className="list-group-item py-3" style={{cursor:"pointer"}} id="3" onClick={handelClick}>
                        <div style={{display: 'flex'}}>
                ...
                <div className="container my-5 mx-2"  onClick={handelClick}>
